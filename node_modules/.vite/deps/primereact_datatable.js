...
import {
  ...
  OverlayService,
  TimesIcon
} from "./chunk-OVVEHKYD.js";
import {
  Button,
  SpinnerIcon
} from "./chunk-OSP43UOS.js";
import {
  IconBase,
  Ripple
} from "./chunk-4WIBVO7T.js";
import {
  InputText
} from "./chunk-YG5BVOCJ.js";
import {
  Tooltip
} from "./chunk-S2ZHZ335.js";
import {
  Portal
} from "./chunk-UQVSUXDK.js";
...
var BodyCell = React26.memo(function(props) {
  ...
  var createElement27 = function createElement28() {
    ...
    if (selectionMode) {
      ...
      var rowEditorSaveIcon = IconUtils.getJSXIcon(props.rowEditorSaveIcon || React26.createElement(CheckIcon, rowEditorSaveIconProps), _objectSpread$a({}, rowEditorSaveIconProps), {
        props
      });
      var rowEditorCancelIcon = IconUtils.getJSXIcon(props.rowEditorCancelIcon || React26.createElement(TimesIcon, rowEditorCancelIconProps), _objectSpread$a({}, rowEditorCancelIconProps), {
        props
      });
      var rowEditorInitIcon = IconUtils.getJSXIcon(props.rowEditorInitIcon || React26.createElement(PencilIcon, rowEditorInitIconProps), _objectSpread$a({}, rowEditorInitIconProps), {
        props
      });
      if (editingState) {
        rowEditorProps = {
...
var DataTable = React26.forwardRef(function(inProps, ref) {
  ...
  var _React$useState19 = React26.useState(props.rows), _React$useState20 = _slicedToArray5(_React$useState19, 2), d_rowsState = _React$useState20[0], setD_rowsState = _React$useState20[1];
  var _React$useState21 = React26.useState({}), _React$useState22 = _slicedToArray5(_React$useState21, 2), d_filtersState = _React$useState22[0], setD_filtersState = _React$useState22[1];
  var metaData = {
    props,
    state: {
      first: firstState,
